	...
	<div  id="mixboard-ui" style="margin: 10px;">
		...
		<div id="ens1" class="row">
		  <div class="col-md-3 col-sm-3" style="text-align: center;">
		  	...
		  	<img id="featureImg" class="img-responsive center-block" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=Feature+Product&w=300&h=300" alt=""/>
		...
		<div id="ens2" class="row">
		  <div class="col-md-3 col-sm-4" style="text-align: center;">
		  	<!-- Anchor Item Space-->
		  	<h4 id="featuredHeadline">Design a room around this item:</h4>
		  	<img id="featureImg" class="img-responsive center-block" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=Feature+Product&w=350&h=350" alt=""/>
		  	<h4>IT’S YOUR WORLD.</h4>
			<p>Experience a new world of furniture shopping—where everything is MADE TO MIX. How will you MIX yours?</p>		  	
		  </div>
        ...
        // test to pass in the bad data-s
        //var rand = 1547976;
        console.log(rand);
		...
		    var obj = data;
			...
			// do nothing; no results found
				...
				$("#featureImg").attr('src', data[0].ensemble[0].image_url);	
							
				for (ens = 0; ens < obj.length; ens++) {
				    var ensemble  = data[ens].ensemble;
					var articleKeysArray = data[ens].articleKeys;
				...
				$("div[id^=key]").on('click','button.itemReplace',function(){
					...
					var removeItem = parseInt($(this).attr("data-iid"));
					...
					var url = "http://shopvcf.com/asiapi/shoptelligence_api_prod.php?items="+itemReplaceList;
					console.log(url);
					...
					$.ajax({
						...
						success: function(data) {
							console.log(data);
							var ensembleReplaceItem = data[1];
							console.log(ensembleReplaceItem);

							var replaceImgURL = data[1].ensemble[removeItemIndex].image_url;
							//console.log(replaceImgURL);
							var cKeyOrder = data[1].ensemble[removeItemIndex].canvas_key_order;
							var swatchImgURL = data[1].ensemble[removeItemIndex].swatch_image_url;
							var item_id = data[1].ensemble[removeItemIndex].item_id;
							console.log(item_id);
							var product_id = data[1].ensemble[removeItemIndex].product_id;
							...
							$(itemReplace).attr('src', replaceImgURL+"?impolicy=product-320x320");	
							// replace link

							console.log(itemReplaceLink);
							$(itemRepalceButton).attr('data-iid', item_id);
