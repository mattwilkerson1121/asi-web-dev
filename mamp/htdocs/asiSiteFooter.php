            ...
            <div class="asi-footer-accordion-container">
                <div id="asi-mobile-footer-shop-footer-item" class="asi-footer-section-list">
                    ...
                    <ul>
                        ...
                        <li><a href="https://www.mysynchrony.com/merchants/cmp-index.html?market=homefurnishings&amp;store=valuecityfurniture">Manage My Value Plus Card</a></li>
                        <li><a href="/search/v/bestsellers">Best Sellers</a></li>
                        <li><a href="/search/v/new-arrivals">New Arrivals</a></li>
                        <li><a href="/search/v/on-sale">What&#39;s On Sale</a></li>
                    </ul>
                </div>
            </div>
            <div class="asi-footer-accordion-container">
                <div id="asi-mobile-footer-care-footer-item" class="asi-footer-section-list">
                    ...
                    <ul>
                        ...
                        <li><a href="/refunds-exchanges">Refunds and Exchanges</a></li>
                    </ul>
                </div>
            </div>
            <div class="asi-footer-accordion-container">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.animated > li').hover(function () {
                $(this).find('.js-megamenu-container').stop(true, true).delay(800).show(0);
            },
            function () {
                $(this).find('.js-megamenu-container').stop(true,true).delay(300).hide(0);
            });
...
<!--- XSELL HiPer VERSION 2 - BLUE-9678 -->
    ...
    <script type="text/javascript" src="/Scripts/ASIMix/vendor/animsition.min.js"></script>
