...
<section class="home-content"><!-- **** asiHero.css & asiHero.js :: YOU MUST INCLUDE THIS FILE FOR THE PLUGIN **** !-->
...
<!-- END : REQUIRED for ASIHERO PLUGIN !-->
            ...
            /*
                ...
                $(function(){
                    $('#asi-fluid-html-hero-0').asiHero({
                        ...
                        messageText : 'MADE TO MIX FURNITURE',
                        messageSubText : 'Discount applies to (UN)TRADITIONAL and MODERN(ISH) Collections. No minimum purchase.',
                        textAlign : 'text-center',
                        fontColor : '#FFFFFF',
    ...
    <style>
        #asi-fluid-html-hero-0 .asi-section{padding-top:0 !important;}
        #asi-fluid-html-hero-0 .asi-mix-contents{background-position:center center !important;}
        ...
        #asi-fluid-html-hero-0 .asi-mix-contents h1.asi-display-1{font-size:96px !important;}
        ...
        @media screen and (min-width:768px){
            ...
            #asi-fluid-html-hero-0 .asi-mix-contents h1.asi-display-1{font-size:120px !important;}
        }
    ...
    <div class="row-fluid home-content-row clearfix">
        <div class="pe-type-id-416">
            <div id="asi-fluid-html-hero-v3"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image container-fluid asi-container-fluid asi-fluid-hero" style="background-image:url(https://asf.scene7.com/is/image/ASF/asi-hp-hero-mix-sebring-lrs.jpg);"><div class="row asi-row"><div id="asi-content-col" class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12"><div class="asi-content asi-content-body" style="padding: 10% 6%;"><div id="asi-hero-wrapper" class="asi-section-content-wrapper" style="padding: 3%;"><p class="asi-urgency-msg text-center" style="color: rgb(255, 255, 255);">GOING ON NOW!</p><p class="asi-lead asi-lead-sale-name text-center">THE LABOR DAY SALE</p><div class="asi-divider"><div class="asi-divider-line"></div></div><h1 class="asiH1 asi-h1 display-1 asi-display-1 text-center" style="color: rgb(255, 255, 255);">FREE DELIVERY</h1><p class="asi-hero-message asi-lead lead asi-hero-lead text-center" style="color: rgb(255, 255, 255);">on orders of $999 or more</p><p class="asi-hero-sub-message asi-sub-lead text-center" style="color: rgb(255, 255, 255);"></p><div id="asi-hero-btn-wrap"><a id="asiHero-button-link" href="/search/v/on-sale" data-pos="0"><button id="asiHero-button" class="asi-mix-button white">SHOP NOW</button></a></div></div></div></div></div></div></div></div>
            <script type="text/javascript">
                $(function(){
                    $('#asi-fluid-html-hero-v3').asiHero({
                        ...
                        dataPosition : '1',
                        divider : 'true',
                        contentCol : 'col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12',
    ...
    <div class="row-fluid home-content-row clearfix">
        <div class="pe-type-id-416" id="asi-pe-2"> 
            <div id="asi-fixed-html-finance-banner-0" class="asi-fixed-hero"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image container asi-container"><div class="row asi-row"><div id="asi-content-col" class="col-md-12 col-sm-12 col-xs-12"><div class="asi-content asi-content-body"><div id="asi-hero-wrapper" class="asi-section-content-wrapper wow  fadeIn animated" data-wow-delay=".25" data-wow-duration="2s" style="background-color:#ee3d42; padding: 25px; visibility: visible; animation-duration: 2s; animation-name: fadeIn;"><p class="asi-hero-message asi-lead lead asi-hero-lead text-center" style="color: rgb(255, 255, 255);"></p><div id="asi-plus-v1" style="margin: 0px auto 15px; padding: 0px; position: relative; max-width: 360px; visibility: visible; animation-duration: 1.5s; animation-delay: 1s; animation-name: fadeIn;" class="wow  fadeIn" data-wow-delay="1s" data-wow-duration="1.5s"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 146 12"><title>asi-black-white-finance-plus</title><rect y="5.5" width="62" height="1"></rect><rect x="72.25" width="2" height="12" style="fill:#fff"></rect><rect x="67.25" y="5" width="12" height="2" style="fill:#fff"></rect><rect x="84" y="5.5" width="62" height="1"></rect></svg></div><h2 class="display-1 asi-display-1 text-center wow  fadeInUp" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">36 MONTHS SPECIAL FINANCING</h2><p class="asi-hero-sub-message asi-sub-lead text-center wow  fadeInUp" style="color: rgb(255, 255, 255); visibility: visible; animation-delay: 0.75s; animation-name: fadeInUp;" data-wow-delay=".75s">when you use your Value Plus credit card on purchases <br class="visible-lg">of $2,999 or more made between 8/1/17 - 8/21/17</p><div id="asi-hero-btn-wrap"><a id="asiHero-button-link" href="/financing" data-pos="1"><button id="asiHero-button" data-wow-delay="1s" data-wow-duration="1.5s" style="visibility: visible; animation-duration: 1.5s; animation-delay: 1s; animation-name: fadeIn;" class="asi-mix-button red wow  fadeIn">GET DETAILS</button></a></div></div></div></div></div></div></div></div>
            <script type="text/javascript">
                ...
                $(function(){
                    $('#asi-fixed-html-finance-banner-0').asiHero({
                        ...
                        headlineText : '<div id="asi-plus-v1" style="margin:0 auto 15px auto;padding:0;position:relative;max-width:360px;" class="wow animated fadeIn" data-wow-delay="1s" data-wow-duration="1.5s"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 146 12"><title>asi-black-white-finance-plus</title><rect y="5.5" width="62" height="1"/><rect x="72.25" width="2" height="12" style="fill:#fff"/><rect x="67.25" y="5" width="12" height="2" style="fill:#fff"/><rect x="84" y="5.5" width="62" height="1"/></svg></div><h2 class="display-1 asi-display-1 text-center">36 MONTHS SPECIAL FINANCING</h2>',
                        ...
                        complete: function(){
                            $('#asi-fixed-html-finance-banner-0 #asi-hero-wrapper').addClass('wow animated fadeIn').attr('data-wow-delay','.25').attr('data-wow-duration','2s').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', nextAnimation());
                            function nextAnimation(){
                                ...
                                $('#asi-fixed-html-finance-banner-0 .asi-mix-button').addClass('wow animated fadeIn').attr('data-wow-delay','1s').attr('data-wow-duration','1.5s').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', $('#asi-fixed-html-finance-banner-0 .asi-content').removeClass('wow animated fadeIn fadeInUp'));
                            }
                        }
                    });
                });
    ...
    <div class="row-fluid home-content-row clearfix">
        <div class="pe-type-id-416a" id="asi-pe-4"> 
            <div id="asi-pe-html-mix-banner"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image container-fluid asi-container-fluid asi-fluid-hero" style="background-image:url(https://asf.scene7.com/is/image/ASF/CM_1840169?qlt=60,1&amp;wid=1180&amp;hei=850&amp;scl=3);"><div id="asi-mix-gradient" style="position: absolute; width: 100%; height: 100%; z-index: 0;" class="asi-gradient-overlay-dark asi-gradient"></div><div class="row asi-row"><div id="asi-content-col" class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0"><div class="asi-content asi-content-body"><div id="asi-hero-wrapper" class="asi-section-content-wrapper" style="padding: 8% 15px;"><p class="asi-urgency-msg text-center" style="color: rgb(255, 255, 255);"></p><h3 class="asiH1 asi-h1 display-1 asi-display-1 text-center asi-white text-uppercase">MIX<br></h3><div class="asi-divider" style="padding-top:2%!important;padding-bottom:4%!important;"><div class="asi-divider-line" style="background:red;width:45px;"></div></div><p class="text-center" style="color: rgb(255, 255, 255);"></p><p class="asi-hero-message asi-lead lead asi-hero-lead text-center" style="color: rgb(255, 255, 255);">—verb (to mix), mixed or mixt, mix•ing<br>1. To create your own unique space using any combination of endless possibilities from within our MADE TO MIX family of furniture.</p><p class="asi-hero-sub-message asi-sub-lead text-center" style="color: rgb(255, 255, 255);"></p><div id="asi-hero-btn-wrap"><a id="asiHero-button-link" href="/made-to-mix" data-pos="2"><button id="asiHero-button" class="asi-mix-button red">EXPLORE MIX</button></a></div></div></div></div></div></div></div></div>
            <script type="text/javascript">
                $(function(){
    ...
    <div class="row-fluid home-content-row clearfix">
        <div class="pe-type-id-416c" id="asi-pe-4-2">
            <div id="asi-pe-html-mix-banner-2" class="asi-fixed-hero"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image container asi-container" style="background-image:url(https://asf.scene7.com/is/image/ASF/s7_1860666_alt?crop=0,1812,8688,3777&amp;anchor=4344,3700);"><div id="asi-mix-gradient" style="position: absolute; width: 100%; height: 100%; z-index: 0;" class="asi-gradient-overlay-dark asi-gradient"></div><div class="row asi-row"><div id="asi-content-col" class="col-lg-8 col-lg-offset-3 col-md-8 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0"><div class="asi-content asi-content-body"><div id="asi-hero-wrapper" class="asi-section-content-wrapper" style="padding: 6% 5%;"><p class="asi-urgency-msg text-left" style="color: rgb(255, 255, 255);">YOUR HOUSE. YOUR RULES.</p><div class="asi-divider"><div class="asi-divider-line"></div></div><h3 class="asiH1 asi-h1 display-1 asi-display-1 text-uppercase asi-white">MIX IT.<br><span class="asi-mix-parens" style="font-family:sans-serif !important;font-weight:300 !important;">(</span>UN<span class="asi-mix-parens" style="font-family:sans-serif !important;font-weight:300 !important;">)</span>MATCH IT.<br>MAKE IT YOU.</h3><p class="asi-hero-message asi-lead lead asi-hero-lead text-left" style="color: rgb(255, 255, 255);"></p><p class="asi-hero-sub-message asi-sub-lead text-left" style="color: rgb(255, 255, 255);"></p><div id="asi-hero-btn-wrap" style="margin: 0px; text-align: left;"><a id="asiHero-button-link" href="/made-to-mix" data-pos="3"><button id="asiHero-button" class="asi-mix-button white">EXPLORE MADE TO MIX</button></a></div></div></div></div></div></div></div></div>
            <script type="text/javascript">
                $(function(){
    ...
    <div class="row-fluid home-content-row clearfix">
        <div class="pe-type-id-416b" id="asi-pe-3">
            <div class="section asi-section" style="background:#ededed !important;padding-top:8%;">
                <div class="asi-container container" style="padding-left: 10px!important; padding-right: 10px!important; text-align:center;margin:0 auto;width:100%;max-width:1200px">
                    <h3 class="asi-section-title asi-display-2 asi-black text-center text-uppercase fix-title">FRESH FINDS FOR FALL</h3>
                    <div class="asi-section-subtitle"><span class="asi-heading-rule-text" style="background:none !important;color:#525050 !important;">SHOP BY CATEGORY</span></div>
                </div>
            </div>
            <div class="section asi-section" style="background:#ededed !important;padding-top:10px;">
                <div class="asi-container container" style="padding-left: 10px!important; padding-right: 10px!important; text-align:center;margin:0 auto;width:100%;max-width:1200px">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 card-type">
                            ...
                            <div class="pmd-card pmd-card-default pmd-z-depth pmd-card-custom-view"> 
                                ...
                                <div class="pmd-card-title text-center">
                                    ...
                                    <a href="#" class="asi-mix-button pmd-btn-flat" data-pos="4">LIVING ROOMS ON SALE</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 card-type">
                            ...
                            <div class="pmd-card pmd-card-default pmd-z-depth pmd-card-custom-view"> 
                                ...
                                <div class="pmd-card-title text-center">
                                    ...
                                    <a href="#" class="asi-mix-button pmd-btn-flat" data-pos="5">BEDROOMS ON SALE</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 card-type">
                            ...
                            <div class="pmd-card pmd-card-default pmd-z-depth pmd-card-custom-view"> 
                                ...
                                <div class="pmd-card-title text-center">
                                    ...
                                    <a href="#" class="asi-mix-button pmd-btn-flat" data-pos="6">DINING ROOMS ON SALE</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 card-type">
                            ...
                            <div class="pmd-card pmd-card-default pmd-z-depth pmd-card-custom-view"> 
                                ...
                                <div class="pmd-card-title text-center">
                                    ...
                                    <a href="#" class="asi-mix-button pmd-btn-flat" data-pos="7">ACCENTS ON SALE</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <style>
        .pmd-card-custom-view{border-radius:0 !important;padding-top:0 !important;padding-bottom:10px!important;margin-bottom:10px !important; background-color:#ffffff;}
    ...
    <div class="row-fluid home-content-row clearfix">
        <div class="pe-type-id-417a"> 
            <div id="asi-fixed-adaptive-img-hero" style="padding-top:10%;" class="asi-fixed-hero"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image asi-adaptive-hero container asi-container"><a href="/search/30-off" data-pos="8"><img class="data-img img-data img-responsive" data-pos="8" src="https://asf.scene7.com/is/image/ASF/Banner_MH_UI_30_Off?fmt=png" data-lrg="https://asf.scene7.com/is/image/ASF/Banner_MH_UI_30_Off?fmt=png" data-med="https://asf.scene7.com/is/image/ASF/Banner_MH_UI_30_Off?fmt=png" data-sml="https://asf.scene7.com/is/image/ASF/Banner_MH_UI_30_Off?fmt=png"></a></div></div></div>
            <script type="text/javascript">
                $(function(){
    ...
    <div class="row-fluid home-content-row clearfix">
        <div class="pe-type-id-417">   
            ...
            <div id="asi-fluid-html-hero"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image container-fluid asi-container-fluid asi-fluid-hero" style="background-image:url(https://asf.scene7.com/is/image/ASF/asi-furniture-tile-bg.jpg);"><div class="row asi-row"><div id="asi-content-col" class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12"><div class="asi-content asi-content-body" style="padding: 12% 15px;"><div id="asi-hero-wrapper" class="asi-section-content-wrapper" style="background-color: rgb(238, 61, 66); padding: 25px;"><p class="asi-urgency-msg text-center" style="color: rgb(255, 255, 255);">ENDS TODAY!</p><div class="asi-divider"><div class="asi-divider-line"></div></div><h1 class="asiH1 asi-h1 display-1 asi-display-1 text-center" style="color: rgb(255, 255, 255);">20% OFF<br>OVERSTOCK</h1><p class="asi-hero-message asi-lead lead asi-hero-lead text-center" style="color: rgb(255, 255, 255);">SCORE SOFAS, CHAIRS, BEDS, &amp; MORE</p><p class="asi-hero-sub-message asi-sub-lead text-center" style="color: rgb(255, 255, 255);">while quantities last - selection may vary by store</p><div id="asi-hero-btn-wrap"><a id="asiHero-button-link" href="on-sale" data-pos="9"><button id="asiHero-button" class="asi-mix-button white">SHOP NOW</button></a></div></div></div></div></div></div></div></div>
            <script type="text/javascript">
                $(function(){
            ...
            <div id="asi-adaptive-img-hero"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image asi-adaptive-hero container-fluid asi-container-fluid asi-fluid-hero"><a href="on-sale" data-pos="10"><img class="data-img img-data img-responsive" data-pos="10" src="https://asf.scene7.com/is/image/ASF/SALE_06WK5Y17?fmt=jpg&amp;qlt=85,1&amp;wid=1920" data-lrg="https://asf.scene7.com/is/image/ASF/SALE_06WK5Y17?fmt=jpg&amp;qlt=85,1&amp;wid=1920" data-med="https://asf.scene7.com/is/image/ASF/SALE_06WK5Y17?fmt=jpg&amp;qlt=85,1&amp;wid=1920" data-sml="https://asf.scene7.com/is/image/ASF/SALE_06WK5Y17?fmt=jpg&amp;qlt=85,1&amp;wid=1920"></a></div></div></div>
            <script type="text/javascript">
                $(function(){
            ...
            <div id="asi-adaptive-img-hero-2"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image asi-adaptive-hero container-fluid asi-container-fluid asi-fluid-hero"><a href="/custom-furniture" data-pos="11"><img class="data-img img-data img-responsive" data-pos="11" src="https://asf.scene7.com/is/image/ASF/cp-kroehler-custom-599-d-hero?fmt=jpg&amp;qlt=85,1&amp;wid=1920" data-lrg="https://asf.scene7.com/is/image/ASF/cp-kroehler-custom-599-d-hero?fmt=jpg&amp;qlt=85,1&amp;wid=1920" data-med="https://asf.scene7.com/is/image/ASF/cp-kroehler-custom-599-d-hero?fmt=jpg&amp;qlt=85,1&amp;wid=1920" data-sml="https://asf.scene7.com/is/image/ASF/cp-kroehler-custom-599-d-hero?fmt=jpg&amp;qlt=85,1&amp;wid=1920"></a></div></div></div>
            <script type="text/javascript">
                $(function(){
            ...
            <div id="asi-fixed-html-hero" class="asi-fixed-hero"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image container asi-container"><div class="row asi-row"><div id="asi-content-col" class="col-md-12 col-sm-12 col-xs-12"><div class="asi-content asi-content-body" style="padding: 0px;"><div id="asi-hero-wrapper" class="asi-section-content-wrapper" style="background-color: rgb(239, 239, 234); padding: 25px;"><p class="asi-urgency-msg text-center" style="color: rgb(82, 80, 80);">ENDS TODAY!</p><div class="asi-divider"><div class="asi-divider-line"></div></div><h1 class="asiH1 asi-h1 display-1 asi-display-1 text-center" style="color: rgb(82, 80, 80);">20% OFF<br>OVERSTOCK</h1><p class="asi-hero-message asi-lead lead asi-hero-lead text-center" style="color: rgb(82, 80, 80);">SCORE SOFAS, CHAIRS, BEDS, &amp; MORE</p><p class="asi-hero-sub-message asi-sub-lead text-center" style="color: rgb(82, 80, 80);"></p><div id="asi-hero-btn-wrap"><a id="asiHero-button-link" href="on-sale" data-pos="12"><button id="asiHero-button" class="asi-mix-button red">SHOP NOW</button></a></div></div></div></div></div></div></div></div>
            <script type="text/javascript">
                $(function(){
            ...
            <div id="asi-fixed-adaptive-img-hero-1" class="asi-fixed-hero"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image asi-adaptive-hero container asi-container"><a href="/search/30-off" data-pos="13"><img class="data-img img-data img-responsive" data-pos="13" src="https://asf.scene7.com/is/image/ASF/Banner_MH_UI_30_Off?fmt=png" data-lrg="https://asf.scene7.com/is/image/ASF/Banner_MH_UI_30_Off?fmt=png" data-med="https://asf.scene7.com/is/image/ASF/Banner_MH_UI_30_Off?fmt=png" data-sml="https://asf.scene7.com/is/image/ASF/Banner_MH_UI_30_Off?fmt=png"></a></div></div></div>
            <script type="text/javascript">
                $(function(){
            ...
            <div id="asi-fixed-html-finance-banner" class="asi-fixed-hero"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image container asi-container"><div class="row asi-row"><div id="asi-content-col" class="col-md-12 col-sm-12 col-xs-12"><div class="asi-content asi-content-body"><div id="asi-hero-wrapper" class="asi-section-content-wrapper" style="background-color: rgb(238, 61, 66); padding: 25px;"><p class="asi-hero-message asi-lead lead asi-hero-lead text-center" style="color: rgb(255, 255, 255);"></p><img class="center-block hidden-xs" style="max-width:350px;padding-bottom:15px;" src="images/asi-red-black-white-plus-icon.png" alt="plus"><h1 class="display-1 asi-display-1 text-center" style="color: rgb(255, 255, 255);">36 MONTHS SPECIAL FINANCING</h1><p class="asi-hero-sub-message asi-sub-lead text-center" style="color: rgb(255, 255, 255);">On purchases of $1999 or more with your Value Plus or Signature Plus credit card made between 6/27/17 - 7/10/17. 36 equal monthly payments required.</p><div id="asi-hero-btn-wrap"><a id="asiHero-button-link" href="/financing" data-pos="14"><button id="asiHero-button" class="asi-mix-button white">GET DETAILS</button></a></div></div></div></div></div></div></div></div>
            <script type="text/javascript">
                $(function(){
            ...
            <div id="asi-fluid-html-hero-left"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image container-fluid asi-container-fluid asi-fluid-hero" style="background-image:url(https://asf.scene7.com/is/image/ASF/asi-furniture-tile-bg.jpg);"><div class="row asi-row"><div id="asi-content-col" class="col-md-3 col-md-offset-2 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1"><div class="asi-content asi-content-body" style="padding: 10% 15px;"><div id="asi-hero-wrapper" class="asi-section-content-wrapper" style="background-color: rgb(238, 61, 66); padding: 0px;"><a href="on-sale" target="_self" data-pos="15"><img src="/images/07WK2Y17_Hero_Offer_Box.png" class="img-responsive" alt="overstocks up to 30% off your order of $999 or more shop now" data-pos="15"></a></div></div></div></div></div></div></div>
            <script type="text/javascript">
                $(function(){
    ...
    <div id="asi-getaway-lr-hero"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image container-fluid asi-container-fluid asi-fluid-hero" style="background-image:url(https://asf.scene7.com/is/image/ASF/asi-getaway-banner-lr-bg.jpg);"><div class="row asi-row"><div id="asi-content-col" class="col-lg-10 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12 col-xs-12"><div class="asi-content asi-content-body" style="padding: 12% 15px;"><div id="asi-hero-wrapper" class="asi-section-content-wrapper" style="padding: 25px;"><p class="asi-urgency-msg text-center" style="color: rgb(255, 255, 255);">GROOM YOUR LIVING ROOM</p><div class="asi-divider"><div class="asi-divider-line"></div></div><h1 class="asiH1 asi-h1 display-1 asi-display-1 text-center" style="color: rgb(255, 255, 255);">10% OFF MIX</h1><p class="asi-hero-message asi-lead lead asi-hero-lead text-center" style="color: rgb(255, 255, 255);">CUSTOM UPHOLSTERY COLLECTIONS</p><p class="asi-hero-sub-message asi-sub-lead text-center" style="color: rgb(255, 255, 255);">MAKE IT YOU AND SAVE</p></div></div></div></div></div></div></div>
    <script type="text/javascript">
        $(function(){
    ...
    <!-- Home-row-6 -->
    <div class="row-fluid home-content-row clearfix">
        <div class="pe-type-id-422"><hr><h2 class="asi-h2 display-2 text-center" style="padding-top:10px;font-size:2.5em; color:#54585a;">Fluid Width HTML Hero - Offer Right Aligned</h2><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image container-fluid asi-container-fluid asi-fluid-hero" style="background-image:url(https://asf.scene7.com/is/image/ASF/asi-furniture-tile-bg.jpg);"><div class="row asi-row"><div id="asi-content-col" class="col-md-3 col-md-offset-7 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1"><div class="asi-content asi-content-body" style="padding: 10% 15px;"><div id="asi-hero-wrapper" class="asi-section-content-wrapper" style="background-color: rgb(238, 61, 66); padding: 0px;"><a href="on-sale" target="_self" data-pos="16"><img src="/images/07WK2Y17_Hero_Offer_Box.png" class="img-responsive" alt="overstocks up to 30% off your order of $999 or more shop now" data-pos="16"></a></div></div></div></div></div></div></div>
    </div>
    ...
    <div class="row-fluid home-content-row clearfix">
        <div class="pe-type-id-427">
            <div id="asi-fixed-adaptive-mhf-hero" class="asi-fixed-hero"><div class="section asi-section asi-mix-hero-wrapper"><div class="asi-mix-contents asi-bg-hero-image asi-adaptive-hero container asi-container"><a href="/search/magnolia-home" data-pos="17"><img class="data-img img-data img-responsive" data-pos="17" src="https://asf.scene7.com/is/image/ASF/HP_Banner_MH_30-OFF_V2?fmt=png" data-lrg="https://asf.scene7.com/is/image/ASF/HP_Banner_MH_30-OFF_V2?fmt=png" data-med="https://asf.scene7.com/is/image/ASF/HP_Banner_MH_30-OFF_V2?fmt=png" data-sml="https://asf.scene7.com/is/image/ASF/HP_Banner_MH_30-OFF_V2?fmt=png"></a></div></div></div>
            <script type="text/javascript">
                $(function(){
    ...
    <div class="row-fluid home-content-row clearfix">
        <div class="pe-type-id-430">
            <div class="asi-container owl-carousel owl-theme owl-loaded owl-drag" style="background:#f4f4f4; padding:10px 0px !important;width:100%;max-width:1180px">
            ...
            <div class="owl-stage-outer"><div class="owl-stage" style="transition: all 0s ease 0s; width: 2640px; transform: translate3d(-990px, 0px, 0px);"><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="seven"><h4>7</h4></div></div><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="eight"><h4>8</h4></div></div><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="nine"><h4>9</h4></div></div><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="ten"><h4>10</h4></div></div><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="eleven"><h4>11</h4></div></div><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="twelve"><h4>12</h4></div></div><div class="owl-item" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="one"><h4>1</h4></div></div><div class="owl-item" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="two"><h4>2</h4></div></div><div class="owl-item" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="three"><h4>3</h4></div></div><div class="owl-item active" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="four"><h4>4</h4></div></div><div class="owl-item active center" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="five"><h4>5</h4></div></div><div class="owl-item active" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="six"><h4>6</h4></div></div><div class="owl-item" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="seven"><h4>7</h4></div></div><div class="owl-item" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="eight"><h4>8</h4></div></div><div class="owl-item" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="nine"><h4>9</h4></div></div><div class="owl-item" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="ten"><h4>10</h4></div></div><div class="owl-item" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="eleven"><h4>11</h4></div></div><div class="owl-item" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="twelve"><h4>12</h4></div></div><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="one"><h4>1</h4></div></div><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="two"><h4>2</h4></div></div><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="three"><h4>3</h4></div></div><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="four"><h4>4</h4></div></div><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="five"><h4>5</h4></div></div><div class="owl-item cloned" style="width: 100px; margin-right: 10px;"><div class="item" data-hash="six"><h4>6</h4></div></div></div></div><div class="owl-nav disabled"><div class="owl-prev">prev</div><div class="owl-next">next</div></div><div class="owl-dots"><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div></div></div>
        </div>
        <style>
        .owl-carousel .item {
            background:#ccc;
