...
<head>
    ...
    <script type="text/javascript">
        ...
        var linkLogin = '/account/sign-in';
        var linkLoginText = 'Login';
        var linkRegistration = '/account/register';
        var linkRegistrationText = 'Register';
        var linkAccount = '/account';
        ...
        // portal session
        //var portalSessionApiUrl = 'www.valuecityfurniture.com/api/customer/getsession';
        //Customer properties
        var isSignedIn = false ;
        var isGuestCheckout = false ;
        // signin service url
        var signinServinceUrl = '/account/signin';
        //ASI Mix header
        ...
        var mvcUrls = {
            ...
            'checkoutWarranty': '/checkout/protection',
